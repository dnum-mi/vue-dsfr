 ...
 */
export declare interface UseSchemeResult {
 ...
 * Si dans les options, `scheme` vaut 'system', le thème sera celui du système, si `scheme` vaut
 * `'light'`, le theme sera clair, et s’il vaut `'dark'`, le thème sera sombre.
 ...
 * @returns <ul>
 * <li>Objet contenant la fonction `setScheme` pour changer le scheme, et les
 * propriétés calculés (réactives et en lecture seule) `theme` et `scheme`.</li>
 * </ul>
 */
