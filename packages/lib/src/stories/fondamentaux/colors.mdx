...
<Meta title="Fondamentaux/2. Les couleurs du DSFR" />

<div style={{border: 'solid 3px orange', fontWeight: 700, padding: '1em', marginBottom: '2rem'}}>

Nous vous recommandons de consulter la [nouvelle documentation ici](https://vue-ds.fr/couleurs)
...
<ColorPalette>
  ...
  <ColorItem
    title="Bleu france"
    subtitle="Palette de bleu france"
    colors={{
  ...
  <ColorItem
    title="Rouge Marianne"
    subtitle="Palette de rouge Marianne"
    colors={{
  ...
  <ColorItem
    title="Info"
    subtitle="Palette de couleur pour les informations"
    colors={{
      '--info-425-625': '#0063cb',
      '--info-850-200': '#bccdff',
      '--info-925-125': '#dde5ff',
  ...
  <ColorItem
    title="Succès"
    subtitle="Palette de couleur pour les bonnes nouvelles"
    colors={{
  ...
  <ColorItem
    title="Danger"
    subtitle="Palette de couleur pour les avertissements"
    colors={{
  ...
  <ColorItem
    title="Erreur"
    subtitle="Palette de couleur pour les erreurs"
    colors={{
  ...
  <ColorItem
    title="Vert tilleul verveine"
    subtitle="Palette de vert tilleul verveine"
    colors={{
  ...
  <ColorItem
    title="Vert bourgeon"
    subtitle="Palette de vert bourgeon"
    colors={{
  ...
  <ColorItem
    title="Vert émeraude"
    subtitle="Palette de vert émeraude"
    colors={{
  ...
  <ColorItem
    title="Vert menthe"
    subtitle="Palette de vert menthe"
    colors={{
  ...
  <ColorItem
    title="Vert archipel"
    subtitle="Palette de vert archipel"
    colors={{
  ...
  <ColorItem
    title="Bleu écume"
    subtitle="Palette de bleu écume"
    colors={{
  ...
  <ColorItem
    title="Bleu cumulus"
    subtitle="Palette de bleu cumulus"
    colors={{
  ...
  <ColorItem
    title="Violet glycine"
    subtitle="Palette de violet glycine"
    colors={{
  ...
  <ColorItem
    title="Rose macaron"
    subtitle="Palette de rose macaron"
    colors={{
  ...
  <ColorItem
    title="Rose tuile"
    subtitle="Palette de rose tuile"
    colors={{
  ...
  <ColorItem
    title="Jaune tournesol"
    subtitle="Palette de jaune tournesol"
    colors={{
  ...
  <ColorItem
    ...
    subtitle="Palette de jaune moutarde"
    colors={{
  ...
  <ColorItem
    title="Orange terre-battue"
    subtitle="Palette d’orange terre-battue"
    colors={{
  ...
  <ColorItem
    title="Marron cafe-creme"
    subtitle="Palette de marron cafe-creme"
    colors={{
  ...
  <ColorItem
    ...
    subtitle="Palette de marron caramel"
    colors={{
  ...
  <ColorItem
    title="Marron opera"
    subtitle="Palette de marron opera"
    colors={{
  ...
  <ColorItem
    title="Beige gris galet"
    subtitle="Palette de beige gris galet"
    colors={{
...
<div data-fr-theme="dark" className="dark" style={{padding: '1rem'}}>
  <ColorPalette>
    <ColorItem
      title="Gris"
      subtitle="Palette de gris"
    ...
    <ColorItem
      ...
      subtitle="Palette de vert menthe"
      colors={{
          '--green-menthe-sun-373-moon-652': '#00a95f',
          '--green-menthe-850-200': '#652',
          '--green-menthe-925-125': '#223f3a',
          '--green-menthe-950-100': '#1f2d2a',
          '--green-menthe-975-75': '#1a2624',
          '--green-menthe-main-548': '#15201e',
        }}
    />
...
## Toutes les variables de couleurs
