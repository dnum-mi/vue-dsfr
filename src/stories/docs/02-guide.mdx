...
[Guide d’utilisation ICI](https://vue-ds.fr/guide/pour-commencer).
...
const app = createApp(App)
  ...
  .component('VIcon', VIcon)                             // Enregistrement global du composant VIcon, dont dépendent certains composants de VueDsfr
  .mount('#app')
```
