...
Ensuite, il faut ajouter un deuxième plugin dans un fichier `dsfr.client.js`, pour charger les scripts
officiels du design system de l’État seulement côté client (ils dépendent de `document` et `window`) :

```javascript
// /plugins/dsfr.client.js
