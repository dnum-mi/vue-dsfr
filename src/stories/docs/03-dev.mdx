...
<div style={{border: 'solid 3px red', fontWeight: 700, padding: '1em'}}>

## Cette documentation est obsolète !

Veuillez vous référer au
[Guide du développeur ICI](https://vue-ds.fr/guide/pour-commencer).
...
Si le paquet cypress n'arrive pas à se télécharger lors de la précédente commande, alors il faut télécharger le fichier cypress.zip manuellement sur le site cypress.io, et spécifier le fichier dans la variable CYPRESS\_INSTALL\_BINARY
