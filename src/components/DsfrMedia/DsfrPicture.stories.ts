...
export default {
  ...
  argTypes: {
    alt: {
      control: 'text',
      description:
        'Présente une alternative textuelle au contenu et optimise le référencement. Si l’image est illustrative, n’apportant  pas d’éléments de compréhension supplémentaires par rapport au texte dans lequel elle se trouve, l’attribut alt doit être vide',
    },
    title: {
      control: 'text',
